...
local AnimatedButtonTemplate = RoactTemplate.fromInstance(RoactCompat, ReplicatedStorage.Assets.Gui.Templates.AnimatedButton)
    ...
    return e(AnimatedButtonTemplate, {
        ...
        Button = {
            ...
            [React.Event.MouseEnter] = function()
                buttonApi.start({
                    size = UDim2.new(props.size.X.Scale * 1.1, props.size.X.Offset, props.size.Y.Scale * 1.1, props.size.Y.Offset)
                })
            end,
